 ...
 * {@code short} values with a custom {@link it.unimi.dsi.fastutil.Hash.Strategy}, the strategy-based
 * counterpart of {@link O2SOpenCacheHashMap}. Each slot stores the key's
