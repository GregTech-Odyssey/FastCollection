 ...
 * {@code float} values with a custom {@link it.unimi.dsi.fastutil.Hash.Strategy}, the strategy-based
 * counterpart of {@link O2FOpenCacheHashMap}. Each slot stores the key's
