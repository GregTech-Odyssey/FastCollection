...
/**
 * A concurrent cache from primitive {@code byte} keys to strong object values.
 ...
 *
 * <p>{@link #getCache(int)} / {@link #getCache(int, Byte2ObjectFunction)} run the
 ...
 */
public final class ByteCache<V> extends OpenCacheTable<ByteCache.Node<V>> {
