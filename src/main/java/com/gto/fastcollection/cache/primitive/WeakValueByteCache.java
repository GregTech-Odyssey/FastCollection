...
/**
 * A concurrent cache from primitive {@code byte} keys to values held by
 ...
 *
 * <p>{@link #getCache(int)} / {@link #getCache(int, Byte2ObjectFunction)} run the create
 ...
 */
public final class WeakValueByteCache<V> extends OpenCacheTable<WeakValueByteCache.Node<V>> implements ICleanableCache {
     ...
     */
    @SuppressWarnings("unchecked")
    private V putIfAbsent(final byte k, final V v, final int mix) {
