...
/**
 * A concurrent cache from primitive {@code long} keys to strong object values.
 ...
 *
 * <p>{@link #getCache(int)} / {@link #getCache(int, LongFunction)} run the
 ...
 */
public final class LongCache<V> extends OpenCacheTable<LongCache.Node<V>> {
