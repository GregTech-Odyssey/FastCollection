...
class ReferenceConsistencyTest {
    ...
    void getCacheReturnsSameInstance(String name, Supplier<MapCache<String, String>> factory) {
        ...
        Function<String, String> createFunction = k -> new String("v:" + k);
        String first = cache.getCache("k", createFunction);
        assertThat(first).isEqualTo("v:k");
        assertThat(cache.getCache("k", createFunction)).isSameAs(first);
        ...
        assertThat(cache.getCacheRecursive("k", createFunction)).isSameAs(first);
