...
/**
 * A segmented concurrent cache from primitive {@code int} keys to strong
 ...
 *
 * <p>{@link #getCache(int)} / {@link #getCache(int, IntFunction)} run the
 ...
 */
public final class IntCache<V> extends Segmented<IntCache.Segment<V>> {
     ...
     * constructor.
     */
    public IntCache(IntFunction<? extends V> createFunction) {
     ...
     */
    public IntCache(int concurrencyLevel) {
     ...
     * @throws IllegalArgumentException if {@code concurrencyLevel} is not positive
     */
    public IntCache(int concurrencyLevel, IntFunction<? extends V> createFunction) {
