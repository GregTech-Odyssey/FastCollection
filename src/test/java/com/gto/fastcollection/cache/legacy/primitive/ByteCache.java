...
/**
 * A segmented concurrent cache from primitive {@code byte} keys to strong
 ...
 *
 * <p>{@link #getCache(byte)} / {@link #getCache(byte, Byte2ObjectFunction)} run the
 ...
 */
public final class ByteCache<V> extends Segmented<ByteCache.Segment<V>> {
     ...
     * constructor.
     */
    public ByteCache(Byte2ObjectFunction<? extends V> createFunction) {
     ...
     */
    public ByteCache(int concurrencyLevel) {
     ...
     * @throws IllegalArgumentException if {@code concurrencyLevel} is not positive
     */
    public ByteCache(int concurrencyLevel, Byte2ObjectFunction<? extends V> createFunction) {
