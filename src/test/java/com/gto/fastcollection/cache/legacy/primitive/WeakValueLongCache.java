...
/**
 * A segmented concurrent cache from primitive {@code long} keys to weak
 ...
 * @see LongCache
 */
public final class WeakValueLongCache<V> extends Segmented<WeakValueLongCache.Segment<V>> implements ICleanableCache {
     ...
     * constructor.
     */
    public WeakValueLongCache(LongFunction<? extends V> createFunction) {
     ...
     */
    public WeakValueLongCache(int concurrencyLevel) {
     ...
     * @throws IllegalArgumentException if {@code concurrencyLevel} is not positive
     */
    public WeakValueLongCache(int concurrencyLevel, LongFunction<? extends V> createFunction) {
