...
/**
 * A segmented concurrent cache from primitive {@code double} keys to weak
 ...
 * @see DoubleCache
 */
public final class WeakValueDoubleCache<V> extends Segmented<WeakValueDoubleCache.Segment<V>> implements ICleanableCache {
     ...
     * constructor.
     */
    public WeakValueDoubleCache(DoubleFunction<? extends V> createFunction) {
     ...
     */
    public WeakValueDoubleCache(int concurrencyLevel) {
     ...
     * @throws IllegalArgumentException if {@code concurrencyLevel} is not positive
     */
    public WeakValueDoubleCache(int concurrencyLevel, DoubleFunction<? extends V> createFunction) {
